...
# Добавьте в конец файла gui.rpy для стилизации новых экранов

## Стили для экрана выбора специальности
style specialty_button is navigation_button
style specialty_button_text is navigation_button_text

style specialty_button:
    xsize 600
    xfill True
